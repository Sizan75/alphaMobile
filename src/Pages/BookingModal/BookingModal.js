            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 mt-10'>
                        ...
                        <input type="text"  defaultValue={sellingPrice} disabled className="input w-full input-bordered input-info " />
                        
                        <input name="name" type="text" defaultValue={user?.displayName} disabled placeholder="Your Name" className="input w-full input-bordered input-info" />
                        <input name="email" type="email" defaultValue={user?.email} disabled placeholder="Email Address" className="input w-full input-bordered input-info" />
                        <input name="phone" type="text" placeholder="Phone Number" className="input w-full input-bordered input-info" />
                        <input name="meetlocation" type="text" placeholder="Meet Up Location" className="input w-full input-bordered input-info" />
                        <br />
